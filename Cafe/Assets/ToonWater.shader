Shader "Roystan/Toon/Water Tut"
{
		...
		SubShader
	{
		...
		v2f vert(appdata v)
		{
			...
			worldPos.y += sin(worldPos.x * _WaveFrequency + _Time.y * _Speed) * _WaveHeight;
			worldPos.y += sin(worldPos.z * _WaveFrequency + _Time.y * _Speed) * _WaveHeight;
			v.vertex = mul(unity_WorldToObject, worldPos);
			//o.vertex = mul(unity_WorldToObject, worldPos);
